/*
Author: Artem Novikov from Stack Overflow
Date Modified: March 21, 2017
IDE: Netbeans 8.2
Program: Generates a random number based on a user-provided minimum and maximum value
File: Wave file utilities, including finding the amplitude at certain frames
 */
 ...
 * Modified slightly to use a resource path instead of a File to support loading resources inside the jar
 */

...
public class Main extends javax.swing.JFrame {
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
        int start, end;//Start and end values
        String output = "[";//Start of output string
        start = Integer.parseInt(startField.getText());//Parse inputs
        end = Integer.parseInt(endField.getText());
        for(int i = start; i <= end; i++){//Iterate through the values
            output += i + ", ";//Add value to output string and add comma
        }
        output = output.substring(0, output.length() - 2);//Remove unnecessary comma from end
        output += "]";//Add closing bracket
        outputLabel.setText(output);//Set output label
